...
fun SelfCareScreen(
    ...
    // Hapus data dummy (articles dan activities)
    ...
    if (uiState.isLoading) {
        ...
        LazyColumn(
            ...
            item {
                ...
                // Recommendation Card
                RecommendationCard(
                    painterRes = R.drawable.onboarding_1, // Biarkan ini, atau ganti
                ...
                LazyRow(
                    ...
                    // Gunakan data 'articles' dari uiState
                    items(uiState.articles) { article ->
                        ArticleCard(
                            ...
                            onClick = {
                                ...
                                // Ambil description atau content jika description null
            ...
            // Gunakan data 'activities' dari uiState
            items(uiState.activities) { activity ->
                ActivityCard(
                    imageUrl = activity.snippet.thumbnails.high.url, // <-- Thumbnail
                    title = activity.snippet.title, // <-- Judul
                    date = formatYouTubeDate(activity.snippet.publishedAt), // <-- Tanggal
